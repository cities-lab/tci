...
#Then a cumulative sum of the percentages is calculated and the zones whoses values add to 
...
#::
     ...
     # Load household data
     load(paste(codeLoc,"/pregen/whiazAry.RData",sep=""))
     ...
     tAvail <-  read.csv(paste(codeLoc,"/inputs/tAvail.csv",sep=""))
