...
OUTPUT_DIR = "data/Corvallis2011/TDM"
dir.create(file.path(OUTPUT_DIR), recursive = TRUE, showWarnings = FALSE)
...
# Combine information in multiple files by modes into 1 data.frame 
...
write.csv(period.factors, file.path(OUTPUT_DIR, "period_factors.csv"), row.names = F)
...
#required data
#1. Trips by purpose, income & mode & tod
#modec/hbw/highInc/[off]Peak
#...

## (specify formula & coefficients)
# mode & tod
#2. travel time Skims
