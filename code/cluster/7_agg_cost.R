  ...
  for (tp in Tp) {
    ...
    for (pr in Pr) { 
      ...
      for (ic in Ic) {
        ...
        # load trips array 
        TotTripsArrayFileName <-  paste("data/CenTTime/results/tripsarray/", pr,ic, "TotTrips.ZiMd.RData", sep="")
        ...
        TimeCostArrayFileName <- paste("data/CenTTime/results/costarray/",pr,ic,tp,"TimeCost.ZiMdCm.RData", sep="")
        ...
        save(list=paste(cm,pr,ic,tp, "AggCost.Zi", sep=""), 
             file = paste("data/CenTTime/results/aggcostcmprictp/", cm, pr,ic, tp,"AggCost.Zi.RData", sep=""))
    ...
    save(list=paste(cm,tp, "AggCost.ZiIcPr", sep=""), 
         file = paste("data/CenTTime/results/aggcostcmtp/", cm, tp,"AggCost.ZiIcPr.RData", sep=""))
...
load("data/CenTTime/results/aggcostcmtp/minoffpeakAggCost.ZiIcPr.RData")

minoffpeakAggCost.ZiIC <- apply(minoffpeakAggCost.ZiIcPr*TripProd.ZiIcPr, c(1,2), function(x) sum(x, na.rm=TRUE))/TripProd.ZiIc
save(minoffpeakAggCost.ZiIC, file="data/CenTTime/results/aggcostcmtp/minoffpeakAggCost.ZiIC.RData")

minoffpeakAggCost.ZiPr <- apply(minoffpeakAggCost.ZiIcPr*TripProd.ZiIcPr, c(1,3), function(x) sum(x, na.rm=TRUE))/TripProd.ZiPr
save(minoffpeakAggCost.ZiPr, file="data/CenTTime/results/aggcostcmtp/minoffpeakAggCost.ZiPr.RData")

minoffpeakAggCost.Zi <- apply(minoffpeakAggCost.ZiIcPr*TripProd.ZiIcPr, 1, function(x) sum(x, na.rm=TRUE))/TripProd.Zi
save(minoffpeakAggCost.Zi, file="data/CenTTime/results/aggcostcmtp/minoffpeakAggCost.Zi.RData")



## aggregate weighted travel time cost during peak time by purpose and inccome group 

load("data/CenTTime/results/aggcostcmtp/weightedoffpeakAggCost.ZiIcPr.RData")
...
save(weightedoffpeakAggCost.ZiIC, file="data/CenTTime/results/aggcostcmtp/weightedoffpeakAggCost.ZiIC.RData")
...
save(weightedoffpeakAggCost.ZiPr, file="data/CenTTime/results/aggcostcmtp/weightedoffpeakAggCost.ZiPr.RData")

weightedoffpeakAggCost.Zi <- apply(weightedoffpeakAggCost.ZiIcPr*TripProd.ZiIcPr, 1, function(x) sum(x, na.rm=TRUE))/TripProd.Zi
save(weightedoffpeakAggCost.Zi, file="data/CenTTime/results/aggcostcmtp/weightedoffpeakAggCost.Zi.RData")



## aggregate minimal travel time cost during peak time by purpose and inccome group

load("data/CenTTime/results/aggcostcmtp/minpeakAggCost.ZiIcPr.RData")

minpeakAggCost.ZiIC <- apply(minpeakAggCost.ZiIcPr*TripProd.ZiIcPr, c(1,2), function(x) sum(x, na.rm=TRUE))/TripProd.ZiIc
save(minpeakAggCost.ZiIC, file="data/CenTTime/results/aggcostcmtp/minpeakAggCost.ZiIC.RData")

minpeakAggCost.ZiPr <- apply(minpeakAggCost.ZiIcPr*TripProd.ZiIcPr, c(1,3), function(x) sum(x, na.rm=TRUE))/TripProd.ZiPr
save(minpeakAggCost.ZiPr, file="data/CenTTime/results/aggcostcmtp/minpeakAggCost.ZiPr.RData")

minpeakAggCost.Zi <- apply(minpeakAggCost.ZiIcPr*TripProd.ZiIcPr, 1, function(x) sum(x, na.rm=TRUE))/TripProd.Zi
save(minpeakAggCost.Zi, file="data/CenTTime/results/aggcostcmtp/minpeakAggCost.Zi.RData")



## aggregate weighted travel time cost during peak time by purpose and inccome group

load("data/CenTTime/results/aggcostcmtp/weightedpeakAggCost.ZiIcPr.RData")
...
save(weightedpeakAggCost.ZiIC, file="data/CenTTime/results/aggcostcmtp/weightedpeakAggCost.ZiIC.RData")
...
save(weightedpeakAggCost.ZiPr, file="data/CenTTime/results/aggcostcmtp/weightedpeakAggCost.ZiPr.RData")

weightedpeakAggCost.Zi <- apply(weightedpeakAggCost.ZiIcPr*TripProd.ZiIcPr, 1, function(x) sum(x, na.rm=TRUE))/TripProd.Zi
save(weightedpeakAggCost.Zi, file="data/CenTTime/results/aggcostcmtp/weightedpeakAggCost.Zi.RData")
