...
hbw.low.pp <- cbind(hbw.low.md2[c("tripid","alt")], predict(hbw.low.dc, newdata=hbw.low.md2, type="probs"))
hbw.med.pp <- cbind(hbw.med.md2[c("tripid","alt")], predict(hbw.med.dc, newdata=hbw.med.md2, type="probs"))
hbw.high.pp <- cbind(hbw.high.md2[c("tripid","alt")], predict(hbw.high.dc, newdata=hbw.high.md2, type="probs"))
hbs.pp <- cbind(hbs.md2[c("tripid","alt")], predict(hbs.dc, newdata=hbs.md2, type="probs"))
hbr.pp <- cbind(hbr.md2[c("tripid","alt")], predict(hbr.dc, newdata=hbr.md2, type="probs"))
hbo.pp <- cbind(hbo.md2[c("tripid","alt")], predict(hbo.dc, newdata=hbo.md2, type="probs"))
```
