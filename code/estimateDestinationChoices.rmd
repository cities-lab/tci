...
```{r,message=FALSE}
setwd("~/tci/doc") # to save the html output resulting from the rmd file in this working directory 
library(RPostgreSQL)
...
hbw.dc <- mlogit(chosen ~ hbw_logsum_avg + I(hbw_logsum_avg^2) + I(hbw_logsum_avg^3)
    				+ RetEmp + SvcEmp + FinEmp + GvtEmp|0|0, hbw.md)
# hbs
...
stargazer(hbw.low.dc, hbw.med.dc, hbw.high.dc, hbw.dc, type="html")
...
stargazer(hbs.dc, hbr.dc, hbo.dc, type="html")
```
