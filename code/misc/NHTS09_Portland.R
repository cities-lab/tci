# This script organizes NHTS2009 in Portland data
...
## settings
INPUT_DIR <- 'data/'
OUTPUT_DIR <- 'output/NHTS09_Portland'
dir.create(file.path(OUTPUT_DIR), recursive=TRUE, showWarnings = FALSE)
# whether to save intermediate results
SAVE.INTERMEDIARIES <- TRUE
INTERMEDIATE_DIR <- "output/intermediate/NHTS09_Portland"
...
# Identify Portland trips 
day <- day %>% 
       filter(HHC_MSA==6442) # 6442 = Portland--Salem, OR--WA; 1637 trips; 162
...
# Define unist cost 
  ...
  MdNames <- c("Car", "Van", "SUV", "Pickup truck", "Light electric veh (golf cart)", 
               "Local public bus", "Commuter bus", "School bus", "Bicycle", "Walk", "Other")
  ...
  # Motorcycle 59.2 
  # RV mode 
  mcpm <- c(59.2, 59.2, 59.2, 59.2, 29.6, 101.0, 101.0, 0, 0, 0, 29.6)/(100 * 24.77)
